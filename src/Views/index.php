...
<div id="content-wrap">
    ...
    <main class="row">
        ...
        <div id="main-content" class="twelve columns">
            ...
            <h1><?php echo esc_html($aOptions['heading']); ?></h1>

            <p> Lorem ipsum dolor sit amet, consectetuer adipiscing. Proin gravida nibh vel velit auctor aliquet. Aenean
                sollicitudin,
    ...
    <div class="row about-content">
        ...
        <div class="six columns mob-whole">
            ...
            <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin,
                lorem quis bibendum auctor, natus error sit voluptatem accusantium nisi elit et quasi architecto beatae
